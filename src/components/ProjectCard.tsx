...
export default function ProjectCard({ project, ratio, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent transition-opacity duration-400 flex flex-col justify-end text-white"
